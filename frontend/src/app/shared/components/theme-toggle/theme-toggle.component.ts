...
@Component({
  ...
  standalone: true,
  template: `
    <button [class]="btnClass" (click)="themeService.toggle()" title="Changer de thème">
...
export class ThemeToggleComponent {
  ...
  /** Set to "sidebar-theme-toggle" to use the sidebar-flavored styling instead of the default navbar one. */
  @Input() btnClass = 'theme-toggle';
}
